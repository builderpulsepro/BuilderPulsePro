...
public class BuilderPulseProDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BuilderPulseProDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
