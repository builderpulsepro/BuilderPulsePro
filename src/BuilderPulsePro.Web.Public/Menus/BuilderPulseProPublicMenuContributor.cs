...
namespace BuilderPulsePro.Web.Public.Menus;

public class BuilderPulseProPublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public BuilderPulseProPublicMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                BuilderPulseProPublicMenus.HomePage,
                l["Menu:HomePage"],
                "~/",
                icon: "fa fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                BuilderPulseProPublicMenus.ArticleSample,
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                BuilderPulseProPublicMenus.ContactUs,
                l["Menu:ContactUs"],
                "~/contact-us",
                icon: "fa fa-phone",
                order: 3
