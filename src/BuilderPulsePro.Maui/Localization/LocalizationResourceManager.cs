...
namespace BuilderPulsePro.Maui.Localization;
...
public class LocalizationResourceManager : INotifyPropertyChanged, ISingletonDependency
{
    ...
    {
        _localizer = serviceProvider.GetRequiredService<IStringLocalizerFactory>().Create(typeof(BuilderPulseProResource));
