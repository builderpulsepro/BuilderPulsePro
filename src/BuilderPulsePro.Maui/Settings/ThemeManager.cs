...
namespace BuilderPulsePro.Maui.Settings;
...
public class ThemeManager : ISingletonDependency
{
    ...
    {
        var storedTheme = await _storage.GetAsync(BuilderPulseProConsts.Settings.Theme);
    ...
    public async Task SetAppThemeAsync(AppTheme theme)
    {
        ...
        await _storage.SetAsync(BuilderPulseProConsts.Settings.Theme, theme.ToString());
    }
}